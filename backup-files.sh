...
tar -cf backup/files.tar --exclude "node_modules" \
  "$ROOT_DIR/Desktop" \
  "$ROOT_DIR/Library/Application Support/JetBrains/Rider2025.1/options/recentSolutions.xml" \
  "$ROOT_DIR/Library/Application Support/JetBrains/WebStorm2025.1/options/recentSolutions.xml" \
